...
void initTargetClassNames(void) {
    ...
    NSMutableArray<NSString *> *list = [@[
        ...
        @"AWEUserNameLabel", @"ACCEditTagStickerView", @"AWEFeedTemplateAnchorViewV2", @"IESECGoodsFeedTagView", @"AWEPlayInteractionSearchAnchorView", @"AFDRecommendToFriendTagView",
